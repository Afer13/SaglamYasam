            ...
            <form style="margin-top: 20px;" action="emeliyyat.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input name="sifaris_ad" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                 <input name="sifaris_seher" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input name="sifaris_telefon" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <textarea name="sifaris_haqqinda"></textarea>
                </div>
              </div>
              <div align="right" class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                <button name="sifariselaveet" type="submit" class="btn btn-success">Əlavə Et</button>
              </div>
            </form>                      
          </div> 
        </div>

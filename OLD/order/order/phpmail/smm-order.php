...
<header class="main-header fixed" id="mainHeader">
								...
								<ul class="sign-lang-wrapper">
									...
									<li class="sign-lang-item-tr change-lang-wrapper sign-lang-wrapper__item mobile-dropdown">
										...
										<div class="choose-lang" id="chooseLang" role="menu">
										   	<a class="lang-item-az" href="https://hostaring.az/az/sifarish/phpmail/smmsifaris.php" role="menuitem"> <span class="country-flag-az"></span>Azərbaycan</a>
    ...
    <div class="container"><br><br><br>
        <div class="panel mr-auto ml-auto text-center p-5 mb-5">
            ...
            <h5 class="mb-4">Your "SMM Service" order has been successfully shipped. You will be contacted within 2 business days. If your time is limited, contact us now by clicking the "Direct Call" button.</h5>
            <a href="tel:+994703001180" class="btn btn-primary btn-lg btn-blue-gr">Direct Call</a>
        </div>
...
function IE(e) {
     if (navigator.appName == "Microsoft Internet Explorer" && (event.button == "2" || event.button == "3")) {
          alert('Burdan görünürki siz sayta başqa məqsədlə gəlmisiniz ;)');
          return false;
     }
}
function NS(e) {
...
if (isset($_POST['seo-order']  )) {
	...
	if($mail->Send()) {
		...
		header("https://hostaring.com/az/sifarish/customer-support.php?smmsifaris=ok");
	} 
	else {
			// bir sorun var, sorunu ekrana bastıralım
		header("Location:https://hostaring.com/az/sifarish/customer-support.php?smmsifaris=no");
	}

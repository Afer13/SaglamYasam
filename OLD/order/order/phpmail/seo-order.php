...
<header class="main-header fixed" id="mainHeader">
		<div class="main-header-container">
			<div  class="brand-logo-wrapper">
             ...
             <img src="https://hostaring.com/img/general/hostaring_white_logo.svg"   class="lozad" id="brand-img" title="Ana səhifəyə geri dön" alt="hostaring.com white logo" data-loaded="true">
             </a>
								...
								<ul class="sign-lang-wrapper">
									...
									<li class="sign-lang-item-tr change-lang-wrapper sign-lang-wrapper__item mobile-dropdown">
										...
										<div class="choose-lang" id="chooseLang" role="menu">
										   	<a class="lang-item-az" href="https://hostaring.az/az/sifarish/phpmail/seosifaris.php" role="menuitem"> <span class="country-flag-az"></span>Azərbaycan</a>
										   	<a class="lang-item-tr" href="https://hostaring.com.tr/tr/siparis/phpmail/seo-siparisi.php" role="menuitem"> <span class="country-flag-tr"></span>Türkce</a>
										   	<a class="lang-item-ru" href="https://hostaring.ru/ru/zakazyvat/phpmail/seo-zakaz.php" role="menuitem"> <span class="country-flag-ru"></span>Русские</a>
    ...
    <div class="container"><br><br><br>
        <div class="panel mr-auto ml-auto text-center p-5 mb-5">
            ...
            <h5 class="mb-4">Your "SEO Optimization" order has been successfully shipped. You will be contacted within 2 business days. If you have limited time, contact us now by clicking the "Direct Call" button.</h5>
...
<script type="text/javascript" defer>
    ...
    $(document).ready (function() {
        ...
        $locales = {"az":{"locale":"az","flag":"az","text":"AZ"}};
...
switch ($flag) {
            case 'az':
                ...
                $address['street'] = 'Mərdəkan';
                $address['postcode'] = '1044';
                $address['city'] = 'Bakı';
                if($country === "az"){
                    $address['country'] = 'Azərbaycan';
                }else if($country === "az"){
...
if (isset($_POST['seo-order']  )) {
	...
	$mail->AddAddress($email, $name);
	$mail->CharSet = 'UTF-8';
	$mail->Subject = 'SEO Order';

	$content = '
	<b>Order from Hostaring</b><br>
	...
	if($mail->Send()) {
		...
		header("https://hostaring.com/az/sifarish/customer-support.php?seosifaris=ok");
		header("https://hostaring.com/az/sifarish/website-support.php?saytsifarisi=ok");
	} 
	else {
			// bir sorun var, sorunu ekrana bastıralım
		header("Location:https://hostaring.com/az/sifarish/customer-support.php?seosifaris=no");
		header("Location:https://hostaring.com/az/sifarish/website-support-support.php?saytsifarisi=no");
	}

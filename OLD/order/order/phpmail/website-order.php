...
<title>Your website order has been sent</title>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">
...
<body>
								...
								<ul class="sign-lang-wrapper">
									...
									<li class="sign-lang-item-tr change-lang-wrapper sign-lang-wrapper__item mobile-dropdown">
										...
										<div class="choose-lang" id="chooseLang" role="menu">
										   	<a class="lang-item-az" href="https://hostaring.az/az/sifarish/phpmail/saytsifaris.php" role="menuitem"> <span class="country-flag-az"></span>Azərbaycan</a>
										   	<a class="lang-item-tr" href="https://hostaring.com.tr/tr/siparis/phpmail/website-siparisi.php" role="menuitem"> <span class="country-flag-tr"></span>Türkce</a>
										   	<a class="lang-item-ru" href="https://hostaring.ru/ru/zakazyvat/phpmail/zakaz-na-sayte.php" role="menuitem"> <span class="country-flag-ru"></span>Русские</a>
    ...
    <div class="container"><br><br><br>
        <div class="panel mr-auto ml-auto text-center p-5 mb-5">
            ...
            <h5 class="mb-4">Your "Website Development" order has been successfully sent. You will be contacted within 2 business days. If you have limited time, contact us now by clicking the "Direct Call" button.</h5>
...
if (isset($_POST['websiteorder']  )) {
	...
	$mail->AddAddress($email, $name);
	$mail->CharSet = 'UTF-8';
	$mail->Subject = 'Website Order';

	$content = '
	<b>Order received from the site</b><br>
	...
	if($mail->Send()) {
		...
		header("https://hostaring.com/order/website-support?website-order=ok");
	} 
	else {
			// bir sorun var, sorunu ekrana bastıralım
		header("Location:https://hostaring.com/order/website-support?website-order=no");
	}
